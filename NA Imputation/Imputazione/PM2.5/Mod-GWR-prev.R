...
for (j in 1:50) {
  ...
  for (i in (inizio):length(d_times)) {
    ...
    if(nrow(na_data) > 0) {
      ...
      #tic()
      #fit_BC <- mgcv::gam(PM2.5_t ~ s(time) + 
      #                      PM2.5_t_1 +
      #                      PM2.5_t_2 +
      #                      PM2.5_t_3 +
      #                      PM2.5_t_4 +
      ...
      tic()
      fit_BC <- spgwr::gwr(PM2.5_t ~ PM2.5_t_1 + 
                             PM2.5_t_2 +
                             PM2.5_t_3 +
                             PM2.5_t_4 +
                             PM2.5_t_5 +
                             ...
                             PM10_t_4 +
                             PM10_t_5 +
                             AirQualityStationType, data = train, 
                           bandwidth = 0.2)
      toc()
      ...
      for (k in 1:length(h_day)) {
        ...
        prev_BC <- spgwr::gwr(PM2.5_t ~ PM2.5_t_1 + 
                                PM2.5_t_2 +
                                PM2.5_t_3 +
                                PM2.5_t_4 +
                                PM2.5_t_5 +
                                ...
                                PM10_t_5 +
                                AirQualityStationType, data = train, 
                              bandwidth = 0.3, fit.points = na_h, predictions = TRUE, fittedGWRobject = fit_BC)
        prev_BC <- prev_BC$SDF$pred
...
col.bw <- spgwr::ggwr.sel(PM2.5_t ~ PM2.5_t_1 + 
                            PM2.5_t_2 +
                            PM2.5_t_3 +
                            PM2.5_t_4 +
                            PM2.5_t_5 +
